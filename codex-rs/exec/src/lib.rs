...
// Parity test in `codex-dotnet/CodexCli.Tests/CrossCliCompatTests.ExecHelpMatches`, `ExecJsonMatches`, `ExecPatchSummaryMatches`, `ExecLastMessageMatches`, `ApplyPatchCliMatches` and `ExecMcpMatches`
