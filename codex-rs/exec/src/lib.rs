...
// Parity test in `codex-dotnet/CodexCli.Tests/CrossCliCompatTests.ExecHelpMatches`, `ExecJsonMatches`, `ExecPatchSummaryMatches`, `ApplyPatchCliMatches` and `ExecMcpMatches`
